...
abstract class AppLocalizations {
  ...
  ///
  /// In en, this message translates to:
  /// **'Join the community of mushroom-loving chefs.'**
  ...
  /// No description provided for @whoDoYouWantToBe.
  ///
  /// In en, this message translates to:
  /// **'Who do you want to be?'**
  String get whoDoYouWantToBe;
  ...
  /// No description provided for @pleaseEnterSixDigits.
  ///
  /// In en, this message translates to:
  /// **'Please enter the 6 digits'**
  String get pleaseEnterSixDigits;
  ...
  /// No description provided for @chefAmateur.
  ///
  /// In en, this message translates to:
  /// **'Amateur Chef | Mushroom Lover'**
  String get chefAmateur;
}
